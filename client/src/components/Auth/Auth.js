        ...
        <div className='p-5 flex justify-center'>
            <div className='flex-col items-center '>
                ...
                <form className='bg-zinc-300 p-24 rounded-2xl shadow-2xl'onSubmit={handleSubmit}>
                    ...
                    <button type="submit" 
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign in</button>
                ...
                <div className='flex items-center justify-center mt-5'>
                    ...
                    type="submit" className="text-white bg-green-50 hover:bg-green-200 focus:ring-3 focus:outline-none focus:ring-green-100 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-cyan-300 dark:hover:bg-cyan-200 dark:focus:ring-cyan-300">
